...
var sdkRESTOperationCoverage = map[string]restOperationCoverage{
	...
	coverageKey("rest.yaml", "getTradingVolume"):            {method: "services.TradingService.GetTradingVolume"},
	coverageKey("rest.yaml", "getNotionalTradingVolume"):    {method: "services.TradingService.GetNotionalTradingVolume"},
