...
export function createStakingTools(client) {
    return [
        {
        ...
        },
        {
            ...
            handler: wrapHandler(({ currency, amount, providerId }) => staking.stake(client, currency, amount, providerId)),
        },
        {
            name: 'gemini_unstake',
            ...
            handler: wrapHandler(({ currency, amount, providerId }) => staking.unstake(client, currency, amount, providerId)),
        },
    ];
}
