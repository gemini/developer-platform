...
export function createAccountTools(client) {
    return [
        {
        ...
        },
        {
            ...
            handler: wrapHandler(({ name, type }) => account.createAccount(client, name, type)),
        },
        {
        ...
        },
        {
            ...
            handler: wrapHandler(({ network }) => account.getApprovedAddresses(client, network)),
        },
        {
