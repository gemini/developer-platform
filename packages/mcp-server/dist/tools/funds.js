...
export function createFundTools(client) {
    return [
        {
        ...
        },
        {
            ...
            handler: wrapHandler(({ currency }) => funds.getNotionalBalances(client, currency)),
        },
        {
            ...
            handler: wrapHandler(({ limitTransfers, currency }) => funds.getTransfers(client, limitTransfers, currency)),
        },
        {
            ...
            handler: wrapHandler(({ network }) => funds.getDepositAddresses(client, network)),
        },
        {
            ...
            handler: wrapHandler(({ network, label }) => funds.getNewDepositAddress(client, network, label)),
        },
        {
            ...
            handler: wrapHandler(({ currency, address, amount, memo }) => funds.cryptoWithdrawal(client, currency, address, amount, memo)),
        },
        {
            ...
            handler: wrapHandler(({ currency, sourceAccount, targetAccount, amount }) => funds.internalTransfer(client, currency, sourceAccount, targetAccount, amount)),
        },
        {
            ...
            handler: wrapHandler((body) => funds.addBank(client, body)),
        },
        {
        ...
        },
        {
            ...
            handler: wrapHandler(({ currency, address, amount }) => funds.getGasFeeEstimate(client, currency, address, amount)),
        },
        {
            ...
            handler: wrapHandler(({ accountId, amount, currency }) => funds.fiatWithdrawal(client, accountId, amount, currency)),
        },
    ];
}
