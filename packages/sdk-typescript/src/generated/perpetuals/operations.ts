...
export const PERPETUALS_OPERATIONS = {
  ...
  "getFundingPaymentReportFile": {"responseMode":"file","operation":"perpetuals.getFundingPaymentReportFile","method":"get","path":"/v1/perpetuals/fundingpaymentreport/records.xlsx","access":"authenticated","parameters":[{"name":"fromDate","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"toDate","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"numRows","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":true,"requestBodyRequired":false,"signQuery":true,"successStatuses":[200],"responseContentTypes":["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"],"responseInt64Paths":[],"requestInt64Paths":{"body":[{"path":["nonce"],"allowString":true}],"path":[],"query":[]},"retryable":true},
