...
export type PerpetualsOperationTypes = {
  ...
  "getFundingPaymentReportJson": {
    ...
    headers: never;
    body: CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["getFundingPaymentReportJson"], true>>>;
  ...
  "getOpenPositions": {
    ...
    headers: never;
    body: CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["getOpenPositions"], true>>>;
  ...
  "listFundingPayments": {
    ...
    headers: never;
    body: CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["listFundingPayments"], true>>>;
