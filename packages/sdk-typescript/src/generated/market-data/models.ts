...
export interface paths {
    ...
    "/v1/nextfundingtimestamp/{symbol}": {
        ...
        get: operations["getNextFundingTimestamp"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** @description Response returned after submitting a v2 cryptocurrency withdrawal. */
        ...
        /** @description Response envelope containing the approved withdrawal addresses. */
        ApprovedAddressesResponse: {
        ...
        ApprovedAddressMessage: {
            /** @description Status or confirmation message for the approved address request or removal. */
            message?: string;
            /** @description Result status (e.g. ok). */
            result?: string;
        };
        CustodyFeeTransfer: {
        ...
        PaymentMethodsResponse: {
            ...
            balances?: components["schemas"]["PaymentMethodBalance"][];
            /** @description Array of JSON objects with banking information */
            banks?: components["schemas"]["PaymentMethodBank"][];
        };
        ...
        AddBankResponse: {
            ...
            referenceId?: string;
            /** @description Status result (e.g. ok). */
            result?: string;
        };
        OpenPosition: {
    ...
    listCustodyFeeTransfers: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CustodyFeeTransfer"][];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
    ...
    withdrawCryptoFunds: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WithdrawCryptoFundsResponse"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["AddBankResponse"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["ApprovedAddressesResponse"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["ApprovedAddressMessage"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthorized"];
