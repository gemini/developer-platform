...
export const MARKET_DATA_OPERATIONS = {
  ...
  "getCurrentOrderBook": {"responseMode":"json","operation":"marketData.getCurrentOrderBook","method":"get","path":"/v1/book/{symbol}","access":"public","parameters":[{"name":"symbol","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"},{"name":"limit_bids","in":"query","required":false,"style":"form","explode":true,"valueType":"number","shape":"scalar","allowReserved":false},{"name":"limit_asks","in":"query","required":false,"style":"form","explode":true,"valueType":"number","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "getFXRate": {"responseMode":"json","operation":"marketData.getFXRate","method":"get","path":"/v2/fxrate/{symbol}/{timestamp}","access":"authenticated","parameters":[{"name":"symbol","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"},{"name":"timestamp","in":"path","required":true,"style":"simple","explode":false,"valueTypes":["string","integer"]}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[{"path":["timestamp"],"allowString":true}],"query":[]},"retryable":true},
  ...
  "getFundingAmountReportFile": {"responseMode":"file","operation":"marketData.getFundingAmountReportFile","method":"get","path":"/v1/fundingamountreport/records.xlsx","access":"public","parameters":[{"name":"symbol","in":"query","required":true,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"fromDate","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"toDate","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"numRows","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","text/csv"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "getNextFundingTimestamp": {"responseMode":"json","operation":"marketData.getNextFundingTimestamp","method":"get","path":"/v1/nextfundingtimestamp/{symbol}","access":"public","parameters":[{"name":"symbol","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[[]],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  ...
  "getTokenNetworkV2": {"responseMode":"json","operation":"marketData.getTokenNetworkV2","method":"get","path":"/v2/network/{token}","access":"authenticated","parameters":[{"name":"token","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "listCandles": {"responseMode":"json","operation":"marketData.listCandles","method":"get","path":"/v2/candles/{symbol}/{time_frame}","access":"public","parameters":[{"name":"symbol","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"},{"name":"time_frame","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "listDerivativeCandles": {"responseMode":"json","operation":"marketData.listDerivativeCandles","method":"get","path":"/v2/derivatives/candles/{symbol}/{time_frame}","access":"public","parameters":[{"name":"symbol","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"},{"name":"time_frame","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  ...
  "listTrades": {"responseMode":"json","operation":"marketData.listTrades","method":"get","path":"/v1/trades/{symbol}","access":"public","parameters":[{"name":"symbol","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"},{"name":"timestamp","in":"query","required":false,"style":"form","explode":true,"valueTypes":["string","integer"],"shape":"scalar","allowReserved":false},{"name":"since_tid","in":"query","required":false,"style":"form","explode":true,"valueType":"number","shape":"scalar","allowReserved":false},{"name":"limit_trades","in":"query","required":false,"style":"form","explode":true,"valueType":"number","shape":"scalar","allowReserved":false},{"name":"include_breaks","in":"query","required":false,"style":"form","explode":true,"valueType":"boolean","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["*","tid"]],"requestInt64Paths":{"body":[],"path":[],"query":[{"path":["timestamp"],"allowString":true}]},"retryable":true},
} as const;
...
export type MarketDataOperationTypes = {
  "getAssetsForNetwork": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getAssetsForNetwork"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getAssetsForNetwork"], "query">>, never, never>;
  ...
  "getCurrentOrderBook": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getCurrentOrderBook"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getCurrentOrderBook"], "query">>, never, never>;
  ...
  "getFXRate": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getFXRate"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getFXRate"], "query">>, never, never>;
  ...
  "getFundingAmount": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getFundingAmount"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getFundingAmount"], "query">>, never, never>;
  ...
  "getFundingAmountReportFile": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getFundingAmountReportFile"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getFundingAmountReportFile"], "query">>, never, never>;
    response: RestFileResponse;
  };
  "getNextFundingTimestamp": {
    path: Int64Input<ParameterAt<OpenApiOperations["getNextFundingTimestamp"], "path">>;
    query: Int64Input<ParameterAt<OpenApiOperations["getNextFundingTimestamp"], "query">>;
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getNextFundingTimestamp"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getNextFundingTimestamp"], "query">>, never, never>;
    response: JsonResponse<OpenApiOperations["getNextFundingTimestamp"], 200>;
  };
  "getSymbolDetails": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getSymbolDetails"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getSymbolDetails"], "query">>, never, never>;
  ...
  "getTicker": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getTicker"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getTicker"], "query">>, never, never>;
  ...
  "getTickerV2": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getTickerV2"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getTickerV2"], "query">>, never, never>;
  ...
  "getTokenNetworkV2": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getTokenNetworkV2"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getTokenNetworkV2"], "query">>, never, never>;
  ...
  "listCandles": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listCandles"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listCandles"], "query">>, never, never>;
  ...
  "listDerivativeCandles": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listDerivativeCandles"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listDerivativeCandles"], "query">>, never, never>;
  ...
  "listFeePromos": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listFeePromos"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listFeePromos"], "query">>, never, never>;
  ...
  "listPrices": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listPrices"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listPrices"], "query">>, never, never>;
  ...
  "listSymbols": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listSymbols"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listSymbols"], "query">>, never, never>;
  ...
  "listTrades": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listTrades"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listTrades"], "query">>, never, never>;
