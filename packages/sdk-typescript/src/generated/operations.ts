...
export const PREDICTION_MARKET_OPERATIONS = {
  ...
  "getCategories": {"responseMode":"json","operation":"predictionMarkets.getCategories","method":"get","path":"/v1/prediction-markets/categories","access":"public","parameters":[{"name":"status","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "getComboByInstrumentSymbol": {"responseMode":"json","operation":"predictionMarkets.getComboByInstrumentSymbol","method":"get","path":"/v1/prediction-markets/combos/{instrumentSymbol}","access":"public","parameters":[{"name":"instrumentSymbol","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["legs","*","comboId"]],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "getEvent": {"responseMode":"json","operation":"predictionMarkets.getEvent","method":"get","path":"/v1/prediction-markets/events/{eventTicker}","access":"public","parameters":[{"name":"eventTicker","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "getEventStrike": {"responseMode":"json","operation":"predictionMarkets.getEventStrike","method":"get","path":"/v1/prediction-markets/events/{eventTicker}/strike","access":"public","parameters":[{"name":"eventTicker","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  ...
  "getLiquidityRewardsDailySummary": {"responseMode":"json","operation":"predictionMarkets.getLiquidityRewardsDailySummary","method":"get","path":"/v1/prediction-markets/liquidity-rewards/summary/daily","access":"authenticated","parameters":[{"name":"dateFrom","in":"query","required":true,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"dateTo","in":"query","required":true,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["daily_summaries","*","events","*","event_id"]],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "getLiquidityRewardsLifetimeSummary": {"responseMode":"json","operation":"predictionMarkets.getLiquidityRewardsLifetimeSummary","method":"get","path":"/v1/prediction-markets/liquidity-rewards/summary/total","access":"authenticated","parameters":[{"name":"dateFrom","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"dateTo","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  ...
  "getMakerRebateRates": {"responseMode":"json","operation":"predictionMarkets.getMakerRebateRates","method":"get","path":"/v1/prediction-markets/maker-rebate/rates","access":"public","parameters":[{"name":"category","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["rate_rules","*","id"]],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  ...
  "getPositions": {"responseMode":"json","operation":"predictionMarkets.getPositions","method":"post","path":"/v1/prediction-markets/positions","access":"authenticated","parameters":[{"name":"eventTicker","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"sort","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["positions","*","instrumentId"]],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":false},
  "getPredictionMarketDailyVolume": {"responseMode":"json","operation":"predictionMarkets.getPredictionMarketDailyVolume","method":"get","path":"/v1/prediction-markets/volume/{date}","access":"public","parameters":[{"name":"date","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "getPredictionMarketHourlyVolume": {"responseMode":"json","operation":"predictionMarkets.getPredictionMarketHourlyVolume","method":"get","path":"/v1/prediction-markets/volume/{date}/hourly","access":"public","parameters":[{"name":"date","in":"path","required":true,"style":"simple","explode":false,"valueType":"string"}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  ...
  "getSettledPositions": {"responseMode":"json","operation":"predictionMarkets.getSettledPositions","method":"post","path":"/v1/prediction-markets/positions/settled","access":"authenticated","parameters":[{"name":"eventTicker","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"sort","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"search","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"category","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"withCashOuts","in":"query","required":false,"style":"form","explode":true,"valueType":"boolean","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["cashOuts","*","accountId"],["cashOuts","*","instrumentId"],["positions","*","accountId"],["positions","*","instrumentId"]],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":false},
  ...
  "listCombos": {"responseMode":"json","operation":"predictionMarkets.listCombos","method":"get","path":"/v1/prediction-markets/combos","access":"public","parameters":[{"name":"status","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"contractId","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"instrumentRegistered","in":"query","required":false,"style":"form","explode":true,"valueType":"boolean","shape":"scalar","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["combos","*","legs","*","comboId"]],"requestInt64Paths":{"body":[],"path":[],"query":[{"path":["contractId"]}]},"retryable":true},
  "listEvents": {"responseMode":"json","operation":"predictionMarkets.listEvents","method":"get","path":"/v1/prediction-markets/events","access":"public","parameters":[{"name":"status","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"category","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sport","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_type","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_subject","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_scope","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_metric","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"search","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "listLiquidityRewardsEvents": {"responseMode":"json","operation":"predictionMarkets.listLiquidityRewardsEvents","method":"get","path":"/v1/prediction-markets/liquidity-rewards/events","access":"public","parameters":[{"name":"category","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"search","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"sort","in":"query","required":false,"style":"form","explode":true,"valueType":"string","shape":"scalar","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "listMakerRebatePayouts": {"responseMode":"json","operation":"predictionMarkets.listMakerRebatePayouts","method":"post","path":"/v1/prediction-markets/maker-rebate/payouts","access":"authenticated","parameters":[{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[["payouts","*","id"]],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":false},
  "listNewlyListedEvents": {"responseMode":"json","operation":"predictionMarkets.listNewlyListedEvents","method":"get","path":"/v1/prediction-markets/events/newly-listed","access":"public","parameters":[{"name":"category","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sport","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_type","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_subject","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_scope","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_metric","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "listRecentlySettledEvents": {"responseMode":"json","operation":"predictionMarkets.listRecentlySettledEvents","method":"get","path":"/v1/prediction-markets/events/recently-settled","access":"public","parameters":[{"name":"category","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sport","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_type","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_subject","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_scope","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_metric","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
  "listUpcomingEvents": {"responseMode":"json","operation":"predictionMarkets.listUpcomingEvents","method":"get","path":"/v1/prediction-markets/events/upcoming","access":"public","parameters":[{"name":"category","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sport","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_type","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_subject","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_scope","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"sports_market_metric","in":"query","required":false,"style":"form","explode":true,"itemType":"string","shape":"array","allowReserved":false},{"name":"limit","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false},{"name":"offset","in":"query","required":false,"style":"form","explode":true,"valueType":"integer","shape":"scalar","allowReserved":false}],"headers":[],"requestBody":false,"requestBodyRequired":false,"successStatuses":[200],"responseContentTypes":["application/json"],"responseInt64Paths":[],"requestInt64Paths":{"body":[],"path":[],"query":[]},"retryable":true},
...
export type PredictionMarketOperationTypes = {
  "acceptPredictionMarketsTerms": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["acceptPredictionMarketsTerms"], "path">>, Int64Input<ParameterAt<OpenApiOperations["acceptPredictionMarketsTerms"], "query">>, never, never>;
  ...
  "cancelOrderBatch": {
    ...
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["cancelOrderBatch"], "path">>, Int64Input<ParameterAt<OpenApiOperations["cancelOrderBatch"], "query">>, never, CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["cancelOrderBatch"], true>>>>;
  ...
  "createCombo": {
    ...
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["createCombo"], "path">>, Int64Input<ParameterAt<OpenApiOperations["createCombo"], "query">>, never, CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["createCombo"], true>>>>;
  ...
  "getActiveOrders": {
    ...
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getActiveOrders"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getActiveOrders"], "query">>, never, CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["getActiveOrders"], false>>>>;
  ...
  "getCategories": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getCategories"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getCategories"], "query">>, never, never>;
  ...
  "getComboByInstrumentSymbol": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getComboByInstrumentSymbol"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getComboByInstrumentSymbol"], "query">>, never, never>;
  ...
  "getEvent": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getEvent"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getEvent"], "query">>, never, never>;
  ...
  "getEventStrike": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getEventStrike"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getEventStrike"], "query">>, never, never>;
  ...
  "getLiquidityRewardsConfig": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getLiquidityRewardsConfig"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getLiquidityRewardsConfig"], "query">>, never, never>;
  ...
  "getLiquidityRewardsDailySummary": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getLiquidityRewardsDailySummary"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getLiquidityRewardsDailySummary"], "query">>, never, never>;
  ...
  "getLiquidityRewardsLifetimeSummary": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getLiquidityRewardsLifetimeSummary"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getLiquidityRewardsLifetimeSummary"], "query">>, never, never>;
  ...
  "getMakerRebateLifetimeSummary": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getMakerRebateLifetimeSummary"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getMakerRebateLifetimeSummary"], "query">>, never, never>;
  ...
  "getMakerRebateRates": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getMakerRebateRates"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getMakerRebateRates"], "query">>, never, never>;
  ...
  "getOrderHistory": {
    ...
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getOrderHistory"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getOrderHistory"], "query">>, never, CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["getOrderHistory"], false>>>>;
  ...
  "getPositions": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getPositions"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getPositions"], "query">>, never, never>;
  ...
  "getPredictionMarketDailyVolume": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketDailyVolume"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketDailyVolume"], "query">>, never, never>;
  ...
  "getPredictionMarketHourlyVolume": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketHourlyVolume"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketHourlyVolume"], "query">>, never, never>;
  ...
  "getPredictionMarketsTerms": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketsTerms"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketsTerms"], "query">>, never, never>;
  ...
  "getPredictionMarketsTermsStatus": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketsTermsStatus"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getPredictionMarketsTermsStatus"], "query">>, never, never>;
  ...
  "getSettledPositions": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getSettledPositions"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getSettledPositions"], "query">>, never, never>;
  ...
  "getVolumeMetrics": {
    ...
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["getVolumeMetrics"], "path">>, Int64Input<ParameterAt<OpenApiOperations["getVolumeMetrics"], "query">>, never, CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["getVolumeMetrics"], true>>>>;
  ...
  "listCombos": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listCombos"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listCombos"], "query">>, never, never>;
  ...
  "listEvents": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listEvents"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listEvents"], "query">>, never, never>;
  ...
  "listLiquidityRewardsEvents": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listLiquidityRewardsEvents"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listLiquidityRewardsEvents"], "query">>, never, never>;
  ...
  "listMakerRebatePayouts": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listMakerRebatePayouts"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listMakerRebatePayouts"], "query">>, never, never>;
  ...
  "listNewlyListedEvents": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listNewlyListedEvents"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listNewlyListedEvents"], "query">>, never, never>;
  ...
  "listRecentlySettledEvents": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listRecentlySettledEvents"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listRecentlySettledEvents"], "query">>, never, never>;
  ...
  "listUpcomingEvents": {
    ...
    headers: never;
    body: never;
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["listUpcomingEvents"], "path">>, Int64Input<ParameterAt<OpenApiOperations["listUpcomingEvents"], "query">>, never, never>;
  ...
  "placeOrder": {
    ...
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["placeOrder"], "path">>, Int64Input<ParameterAt<OpenApiOperations["placeOrder"], "query">>, never, CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["placeOrder"], true>>>>;
  ...
  "placeOrderBatch": {
    ...
    input: FlatInput<Int64Input<ParameterAt<OpenApiOperations["placeOrderBatch"], "path">>, Int64Input<ParameterAt<OpenApiOperations["placeOrderBatch"], "query">>, never, CallerJsonBody<Int64Input<JsonBody<OpenApiOperations["placeOrderBatch"], true>>>>;
